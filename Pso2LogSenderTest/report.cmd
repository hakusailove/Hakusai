...
REM 対象設定
set TARGET=Pso2LogSenderTest.dll

"%OPENCOVER%" -register:user -target:"%NUNITCONS%" -targetargs:"%TARGET%" "-filter:+[Pso2LogSender]* -[*]*.NamespaceDoc" -hideskipped:All -output:"%COVXML%"
"%REPORTGEN%" "-reports:%COVXML%" "-targetdir:%TARGETDIR%" -filters:+Pso2LogSender